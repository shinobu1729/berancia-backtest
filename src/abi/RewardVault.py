abi = [
    ...
    {"inputs": [], "name": "CurrentIncentiveVaultsAreInvalid", "type": "error"},
    ...
    {"inputs": [], "name": "InvalidIncentiveVaultWeights", "type": "error"},
    ...
    {"inputs": [], "name": "PayoutTokenIsNotIncentiveToken", "type": "error"},
    {"inputs": [], "name": "QueuedIncentiveVaultsAreEmpty", "type": "error"},
    ...
    {"inputs": [], "name": "ZeroPercentageWeight", "type": "error"},
    {
        ...
        "name": "BGTBoosterIncentivesProcessFailed",
        "type": "event",
    },
    {
        "anonymous": False,
